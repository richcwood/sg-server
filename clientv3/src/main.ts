...
import { faSearch, faSpinner, faEllipsisH, faQuestionCircle, faAngleDown, faCalendarAlt, faCog, faUsers, faSignOutAlt, faAngleUp } from '@fortawesome/free-solid-svg-icons';
