...
import { faSearch, faSpinner, faEllipsisH, faQuestionCircle, faAngleDown, faCalendarAlt, faCog, faUsers, faSignOutAlt, faAngleUp, faTimes, faCode } from '@fortawesome/free-solid-svg-icons';
