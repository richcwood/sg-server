  ...
  <div>
    ...
    <validation-observer ref="editTaskDefValidationObserver">
      <table class="table">
        <tr class="tr">
          <td class="td">
            <label class="label">AWS Lambda Task Name</label>
          </td>
          <td class="td">
...
export default class AWSLambdaTaskDef extends Vue {
  ...
  private onTaskDefChanged(){
    ...
    if(stepDefs.length === 1){
      ...
      console.warn('For some reason, your AWS Lambda task did not have a default step or it had more than 1');
      return null;
    }
  }
