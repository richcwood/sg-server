...
// Pretty strings that are easier to read
const momentToStringV1 = function(input: moment.Moment | string | number): string {
  if(input){
    ...
    if(now.isSame(input, 'day')){
      return `today ${momentInput.format('h:mm a')}`;
    }
    else if(now.subtract(1, 'days').isSame(input, 'day')){
      return `yesterday ${momentInput.format('h:mm a')}`;
    }
    else {
      return momentInput.format('MMM D YYYY  h:mm a');
    }
  }
  else {
    return '';
...
const momentToStringV2 = function(input: moment.Moment | string | number): string {
  if(input){
    let momentInput: moment.Moment;
    ...
    if(now.isSame(input, 'day')){
      return `today ${momentInput.format('h:mm:ss a')}`;
    }
    else if(now.subtract(1, 'days').isSame(input, 'day')){
      return `yesterday ${momentInput.format('h:mm:ss a')}`;
    }
    else {
      return momentInput.format('MMM D YYYY  h:mm:ss a');
    }
  }
  else {
    return '';
...
const momentToStringV3 = function(input: moment.Moment | string | number): string {
  if(input){
    ...
    if(now.isSame(input, 'day')){
      ...
      return momentInput.format('MMM D YYYY');
    }
  }
  else {
    return '';
