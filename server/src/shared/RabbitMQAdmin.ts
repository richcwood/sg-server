...
export class RabbitMQAdmin {
    ...
    async getConnections(): Promise<any[]> {
        return new Promise((resolve, reject) => {
            this.instance
                .get(`vhosts/${this.vhost}/connections`)
                .then((response) => {
    ...
    async createExchange(exchange: string, type: string, autoDelete: boolean, durable: boolean) {
        return new Promise((resolve, reject) => {
            this.instance
                .put(`exchanges/${this.vhost}/${exchange}`, { type: type, 'auto-delete': autoDelete, durable: durable })
                .then((response) => {
                    resolve(response.status);
                })
                .catch((err) => {
    ...
    async bindExchanges(source: string, destination: string, routingKey: string) {
        return new Promise((resolve, reject) => {
            this.instance
                .post(`bindings/${this.vhost}/e/${source}/e/${destination}`, { routing_key: routingKey })
                .then((response) => {
                    resolve(response.status);
                })
                .catch((err) => {
    ...
    async bindQueueToExchange(exchange: string, queue: string, routingKey: string) {
        return new Promise((resolve, reject) => {
            this.instance
                .post(`bindings/${this.vhost}/e/${exchange}/q/${queue}`, { routing_key: routingKey })
                .then((response) => {
                    resolve(response.status);
                })
                .catch((err) => {
