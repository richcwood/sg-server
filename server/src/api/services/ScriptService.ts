...
export class ScriptService {
    ...
    public async createScript(
        ...
        else if (data.code) this.extractInjectionElems(data);
        ...
        await rabbitMQPublisher.publish(
            ...
            convertData(ScriptSchema, newScript)
        );
    ...
    public async updateScript(
        ...
        await rabbitMQPublisher.publish(
            ...
            convertData(ScriptSchema, deltas)
        );
    ...
    public async deleteScript(
        ...
        if (cntStepDefsTargetingThisAgent > 0)
            throw new ValidationError(
                `There are ${cntStepDefsTargetingThisAgent} job steps that are using this script`
            );
