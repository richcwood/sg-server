...
export class PasswordResetService {
    public async updatePassword(data: any, logger: BaseLogger, responseFields?: string): Promise<object> {
        ...
        if (!userModel) throw new ValidationError('Something went wrong. Please request a new password reset link.');
        ...
        if (!tokenIsValid) throw new ValidationError('Something went wrong. Please request a new password reset link.');
