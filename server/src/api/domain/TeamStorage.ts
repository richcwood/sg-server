...
@modelOptions({ schemaOptions: { collection: 'teamStorage' }, options: { allowMixed: Severity.ALLOW } })
export class TeamStorageSchema {
    ...
    public static readonly dataConverters = {
        ...
        fromDB: {
            // version: (data) => {
            //   return undefined; // remove the version field - api teamStorages won't see it
            // }
        },
    };
}

export const TeamStorageModel = getModelForClass(TeamStorageSchema);
