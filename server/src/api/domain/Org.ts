...
export class OrgSchema {
  ...
  @prop({ default: OrgPaymentStatus.HEALTHY })
  ...
  @prop({ default: OrgPricingTier.FREE })
...
export const OrgModel = getModelForClass(OrgSchema);