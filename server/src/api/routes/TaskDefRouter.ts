...
export class TaskDefRouter {
  ...
  constructor() {
    ...
    this.router.put('/:taskDefId', verifyAccessRights(['JOB_DEF_WRITE', 'GLOBAL']),  taskDefController.updateTaskDef);
    this.router.delete('/:taskDefId', verifyAccessRights(['JOB_DEF_WRITE', 'GLOBAL']),  taskDefController.deleteTaskDef);
  }
}
