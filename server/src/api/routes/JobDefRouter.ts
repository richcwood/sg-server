...
export class JobDefRouter {
  ...
  constructor() {
    ...
    this.router.post('/script', verifyAccessRights(['JOB_DEF_WRITE', 'GLOBAL']), jobDefController.createJobDefFromScript);
    this.router.post('/copy', verifyAccessRights(['JOB_DEF_WRITE', 'GLOBAL']), jobDefController.createJobDefFromJobDef);
    this.router.put('/:jobDefId', verifyAccessRights(['JOB_DEF_WRITE', 'GLOBAL']), jobDefController.updateJobDef);
    this.router.delete('/:jobDefId', verifyAccessRights(['JOB_DEF_WRITE', 'GLOBAL']),  jobDefController.deleteJobDef);
  }
}
