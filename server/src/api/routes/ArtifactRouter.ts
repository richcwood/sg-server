...
export class ArtifactRouter {
  ...
  constructor() {
    ...
    this.router.put('/:artifactId', verifyAccessRights(['ARTIFACT_WRITE', 'GLOBAL']), artifactController.updateArtifact);
    this.router.delete('/:artifactId', verifyAccessRights(['ARTIFACT_WRITE', 'GLOBAL']), artifactController.deleteArtifact);
  }
}
