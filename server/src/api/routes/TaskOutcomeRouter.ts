...
export const taskOutcomeRouterSingleton = (): TaskOutcomeRouter | any => {
    return new TaskOutcomeRouter();
};
export const taskOutcomeRouter = (): any => {
    return taskOutcomeRouterSingleton().router;
};
