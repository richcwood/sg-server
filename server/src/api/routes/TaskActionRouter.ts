...
export class TaskActionRouter {
  ...
  constructor() {
    ...
    this.router.post('/republish/:taskId', verifyAccessRights(['TASK_ACTION', 'GLOBAL']), taskActionController.republishTask);
    this.router.post('/requeue/:taskId', verifyAccessRights(['TASK_ACTION', 'GLOBAL']), taskActionController.requeueTask);
  }
}
