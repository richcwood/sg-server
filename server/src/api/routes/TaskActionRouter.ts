...
export const taskActionRouterSingleton = (): TaskActionRouter | any => {
    return new TaskActionRouter();
};
export const taskActionRouter = (): any => {
    return taskActionRouterSingleton().router;
};
