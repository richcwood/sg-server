...
class RabbitMQPublisher {
    ...
    public async publish(
        ...
        this.amqp.PublishRoute(SGStrings.GetTeamExchangeName(_teamId.toHexString()), rmqBrowserPushRoute, {
            domainType,
            operation,
            model: data,
            correlationId,
    ...
    public async publishBrowserAlert(_teamId: mongodb.ObjectId, message: string) {
        ...
        this.amqp.PublishRoute(SGStrings.GetTeamExchangeName(_teamId.toHexString()), rmqBrowserAlertsRoute, {
            message,
        });
    }
    ...
    public async publishToAgent(_teamId: mongodb.ObjectId, _agentId: mongodb.ObjectId, data: any) {
        ...
        this.amqp.PublishQueue(
            SGStrings.GetTeamRoutingPrefix(_teamId.toHexString()),
            SGStrings.GetAgentUpdaterQueue(_teamId.toHexString(), _agentId.toHexString()),
            data,
            agentQueueProperties,
            { expiration: defaultAgentUpdateMessageTTL }
        );
    }
