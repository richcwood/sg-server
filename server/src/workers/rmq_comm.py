...
class AsyncConsumer(object):
    ...
    def basic_publish(self, msg, routing_key):
        ...
        self._logger.info(json.dumps({"msg": "Sent message to rabbitmq", "routing_key": routing_key, "msg_json": msg_json}))
...
def main():
    ...
    num_threads = 1
    start_async_consumer_multithreaded('amqps://erpbwfab:2Y6n7quHHysEiRauCLD2O9bNex0h8zLJ@grand-silver-bat.rmq4.cloudamqp.com/sgProd', cml_adapter, {
        'exch': 'mission',
        'exch_type': 'topic',
        'durable': True,
