...
export default class Test24 extends TestBase.default {
    ...
    public async CreateTest() {
        ...
        // /// Create org
        // let org: any = {'name': 'TestOrg23', 'isActive': true, 'rmqPassword': SGUtils.makeid(10)};
        ...
        script_obj1 = { '_orgId': _orgId, 'name': 'Script 24', 'scriptType': Enums.ScriptType.SH, 'code': script1_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script1_b64 };
        script_obj1 = await self.CreateScript(script_obj1, _orgId);
        self.scripts.push(script_obj1);
        let step: StepDefSchema = { '_orgId': _orgId, '_taskDefId': taskDef1.id, 'name': 'step1', '_scriptId': script_obj1['id'], 'order': 0, 'arguments': 'hello'};
