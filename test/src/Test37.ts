...
export default class Test37 extends TestBase.default {
    ...
    public async CreateTest() {
        ...
        let taskDef1: TaskDefSchema = {'_teamId': _teamId, 'name': 'Task1_1', '_jobDefId': jobDef.id, 'target': Enums.TaskDefTarget.ALL_AGENTS, 'requiredTags': {}, 'fromRoutes': [], 'toRoutes': [['Task1_3', 'ok']]};
        ...
        /// Create scripts
        let script_obj1: ScriptSchema = { '_teamId': _teamId, 'name': 'Script 37.1', 'scriptType': Enums.ScriptType.PYTHON, 'code': script1_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script1_b64 };
        ...
        let script_obj3: ScriptSchema = {'_teamId': _teamId, 'name': 'Script 37.3', 'scriptType': Enums.ScriptType.PYTHON, 'code': script3_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script1_b64 };
