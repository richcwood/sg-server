...
export default class Test33 extends TestBase.default {
    ...
    public async CreateTest() {
        ...
        // /// Create team
        // let team: any = {'name': 'TestTeam33', 'isActive': true, 'rmqPassword': SGUtils.makeid(10)};
        ...
        /// Create scripts
        let script_obj1: ScriptSchema = { '_teamId': _teamId, 'name': 'Script 33.1', 'scriptType': Enums.ScriptType.PYTHON, 'code': script1_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script1_b64 };
        ...
        let script_obj2: ScriptSchema = {'_teamId': _teamId, 'name': 'Script 33.2', 'scriptType': Enums.ScriptType.PYTHON, 'code': script2_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script2_b64 };
        script_obj2 = await self.CreateScript(script_obj2, _teamId);
        self.scripts.push(script_obj2);    
        let step2: any = {'_teamId': _teamId, '_taskDefId': taskDef1.id, 'name': 'step2', '_scriptId': script_obj2['id'], 'order': 1, 'arguments': '', 'variables': {'GLOBAL_PARAM_1': ''}};
        ...
        taskDef1.expectedValues = {
            ...
            'runtimeVars': {[SGStrings.route]: 'ok', 'GLOBAL_PARAM_1': 'globalParam1_val', 'globalParam1': 'globalParam1_val'}, 
            'cntPartialMatch': 0, 
            'cntFullMatch': 0
        };    
