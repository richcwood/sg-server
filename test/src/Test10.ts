...
export default class Test10 extends TestBase.FailedTestBase {
    ...
    public async SetupJobRelaunch() {
        ...
        const taskDef1_9: TaskDefSchema = lodash.filter(
            self.taskDefs,
            (x) => x.name === 'Task1_9' && x._jobDefId === jobDef.id
        )[0];
    ...
    public async CreateTest() {
        ...
        let taskDef1_7: TaskDefSchema = {
            _teamId: _teamId,
            name: 'Task1_7',
            _jobDefId: jobDef.id,
            target: Enums.TaskDefTarget.SINGLE_AGENT,
            requiredTags: {},
            fromRoutes: [['Task1_1', 'fail']],
        };
        taskDef1_7 = await self.CreateTaskDef(taskDef1_7, _teamId);

        let taskDef1_4: TaskDefSchema = {
            _teamId: _teamId,
            name: 'Task1_4',
            _jobDefId: jobDef.id,
            target: Enums.TaskDefTarget.SINGLE_AGENT,
        ...
        let taskDef1_6: TaskDefSchema = {
            _teamId: _teamId,
            name: 'Task1_6',
            _jobDefId: jobDef.id,
            target: Enums.TaskDefTarget.SINGLE_AGENT,
            requiredTags: {},
            fromRoutes: [['Task1_5'], ['Task1_3']],
        };
        ...
        let taskDef2_3: TaskDefSchema = {
            _teamId: _teamId,
            name: 'Task2_3',
            _jobDefId: jobDef.id,
            target: Enums.TaskDefTarget.SINGLE_AGENT,
            requiredTags: {},
            fromRoutes: [['Task2_1', 'ok'], ['Task2_2']],
        };
        taskDef2_3 = await self.CreateTaskDef(taskDef2_3, _teamId);

        let taskDef2_8: TaskDefSchema = {
            _teamId: _teamId,
            name: 'Task2_8',
            _jobDefId: jobDef.id,
            target: Enums.TaskDefTarget.SINGLE_AGENT,
        ...
        let taskDef2_7: TaskDefSchema = {
            _teamId: _teamId,
            name: 'Task2_7',
            _jobDefId: jobDef.id,
            target: Enums.TaskDefTarget.SINGLE_AGENT,
            requiredTags: {},
            fromRoutes: [['Task2_1', 'fail']],
        };
        taskDef2_7 = await self.CreateTaskDef(taskDef2_7, _teamId);

        let taskDef2_4: TaskDefSchema = {
            _teamId: _teamId,
            name: 'Task2_4',
            _jobDefId: jobDef.id,
            target: Enums.TaskDefTarget.SINGLE_AGENT,
        ...
        let taskDef2_6: TaskDefSchema = {
            _teamId: _teamId,
            name: 'Task2_6',
            _jobDefId: jobDef.id,
            target: Enums.TaskDefTarget.SINGLE_AGENT,
            requiredTags: {},
            fromRoutes: [['Task2_5'], ['Task2_3']],
        };
        ...
        taskDef1_8.expectedValues = {
            ...
            step: [{ name: step4.name, values: { status: Enums.TaskStatus.FAILED, stderr: '', exitCode: 1 } }],
