...
export default class Test34 extends TestBase.default {
    ...
    public async CreateTest() {
        ...
        /// Create scripts
        let script_obj1: ScriptSchema = { '_orgId': _orgId, 'name': 'Script 34.1', 'scriptType': Enums.ScriptType.PYTHON, 'code': script1_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script1_b64 };
        ...
        let script_obj2: ScriptSchema = { '_orgId': _orgId, 'name': 'Script 34.2', 'scriptType': Enums.ScriptType.PYTHON, 'code': script2_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script1_b64 };
        ...
        let script_obj4: ScriptSchema = { '_orgId': _orgId, 'name': 'Script 34.4', 'scriptType': Enums.ScriptType.PYTHON, 'code': script4_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script4_b64 };
        script_obj4 = await self.CreateScript(script_obj4, _orgId);
        self.scripts.push(script_obj4);
        let step4: StepDefSchema = { '_orgId': _orgId, '_taskDefId': '', 'name': 'step4', '_scriptId': script_obj4['id'], 'order': 0, 'arguments': '' };
        await self.CreateStepDef(Object.assign(step4, { _taskDefId: taskDef2.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step4, { _taskDefId: taskDef8.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step4, { _taskDefId: taskDef9.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step4, { _taskDefId: taskDef4.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step4, { _taskDefId: taskDef5.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step4, { _taskDefId: taskDef6.id }), _orgId, jobDef.id);

        let script_obj5: ScriptSchema = { '_orgId': _orgId, 'name': 'Script 34.5', 'scriptType': Enums.ScriptType.PYTHON, 'code': script5_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script5_b64 };
        script_obj5 = await self.CreateScript(script_obj5, _orgId);
        self.scripts.push(script_obj5);
        let step5: StepDefSchema = { '_orgId': _orgId, '_taskDefId': '', 'name': 'step5', '_scriptId': script_obj5['id'], 'order': 0, 'arguments': '' };
        await self.CreateStepDef(Object.assign(step5, { _taskDefId: taskDef2.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step5, { _taskDefId: taskDef8.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step5, { _taskDefId: taskDef9.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step5, { _taskDefId: taskDef4.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step5, { _taskDefId: taskDef5.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step5, { _taskDefId: taskDef6.id }), _orgId, jobDef.id);

        let script_obj6: ScriptSchema = { '_orgId': _orgId, 'name': 'Script 34.6', 'scriptType': Enums.ScriptType.PYTHON, 'code': script6_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script6_b64 };
        script_obj6 = await self.CreateScript(script_obj6, _orgId);
        self.scripts.push(script_obj6);
        let step6: StepDefSchema = { '_orgId': _orgId, '_taskDefId': '', 'name': 'step6', '_scriptId': script_obj6['id'], 'order': 0, 'arguments': '' };
        await self.CreateStepDef(Object.assign(step6, { _taskDefId: taskDef2.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step6, { _taskDefId: taskDef8.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step6, { _taskDefId: taskDef9.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step6, { _taskDefId: taskDef4.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step6, { _taskDefId: taskDef5.id }), _orgId, jobDef.id);
        await self.CreateStepDef(Object.assign(step6, { _taskDefId: taskDef6.id }), _orgId, jobDef.id);

        let script_obj3: ScriptSchema = { '_orgId': _orgId, 'name': 'Script 34.3', 'scriptType': Enums.ScriptType.PYTHON, 'code': script3_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script1_b64 };
