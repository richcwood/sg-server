    ...
    public async CreateTest() {
        ...
        taskDef2.expectedValues = {
            ...
            step: [
                {
                    name: step2.name,
                    values: { status: Enums.TaskStatus.SUCCEEDED, stderr: '', exitCode: 0, stdout: 'start\ndone\n' },
                },
                {
                    name: step4.name,
                    values: {
