...
export default class Test52 extends TestBase.WorkflowTestBase {
    constructor(testSetup) {
        ...
        this.description =
            'Multi-task job - no agent for task - downstream tasks should not run - create agent with tags - tasks should now complete';
    ...
    public async RunTest() {
        ...
        const newAgentProperties = {
            _teamId: _teamId,
            machineId: 'TestAgent5',
            ipAddress: '10.10.0.94',
            tags: { nomatch: 'true' },
            numActiveTasks: 0,
            lastHeartbeatTime: null,
            rmqPassword: self.testSetup.teams['TestTeam']['rmqPassword'],
        };
