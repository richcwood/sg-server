...
export default class Test27 extends TestBase.default {
    ...
    public async CreateTest() {
        ...
        // /// Create team
        // let team: any = {'name': 'TestTeam27', 'isActive': true, 'rmqPassword': SGUtils.makeid(10)};
        ...
        script_obj1 = { '_teamId': _teamId, 'name': 'Script 27', 'scriptType': Enums.ScriptType.SH, 'code': script1_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script1_b64 };
