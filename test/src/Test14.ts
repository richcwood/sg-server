...
export default class Test14 extends TestBase.ScheduledJobTestBase {
    ...
    public async CreateTest() {
        ...
        // /// Create team
        // let team: any = { 'name': 'TestTeam14', 'isActive': true, 'rmqPassword': SGUtils.makeid(10) };
        ...
        /// Create script
        let script_obj1: ScriptSchema = { '_teamId': _teamId, 'name': 'Script 14', 'scriptType': Enums.ScriptType.PYTHON, 'code': script1_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script1_b64 };
        ...
        let schedule = {
            '_teamId': _teamId, 'name': 'Schedule_1', 'isActive': true, '_jobDefId': jobDef['id'], 
