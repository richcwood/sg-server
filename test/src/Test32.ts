...
export default class Test32 extends TestBase.default {
    ...
    public async CreateTest() {
        ...
        // /// Create team
        // let team: any = {'name': 'TestTeam32', 'isActive': true, 'rmqPassword': SGUtils.makeid(10)};
        ...
        let jobDef: JobDefSchema = {
            ...
            runtimeVars: { GLOBAL_PARAM_1: { 'sensitive': false, 'value': 'globalParam1_val' } },
        ...
        /// Create scripts
        let script_obj: ScriptSchema = {'_teamId': _teamId, 'name': 'Script 32', 'scriptType': Enums.ScriptType.PYTHON, 'code': script_b64, _originalAuthorUserId: this.sgUser.id, _lastEditedUserId: this.sgUser.id, lastEditedDate: new Date(), shadowCopyCode: script_b64 };
        script_obj = await self.CreateScript(script_obj, _teamId);
        self.scripts.push(script_obj);    
        let step2: any = {'_teamId': _teamId, '_taskDefId': taskDef.id, 'name': 'step2', '_scriptId': script_obj['id'], 'order': 0, 'arguments': '', 'variables': {'GLOBAL_PARAM_1': ''}};
